    ...
    <jsp:attribute name="javascripts">
        <script type="text/javascript">
            function post(id) {
                swal({
                    title: "Are you sure?",
                    text: "Your will not be able to recover this discipline!",
                    type: "warning",
                ...
                <div class="panel-body">
                    <table class="table table-hover table-responsive">
                        ...
                        <c:forEach var="discipline" items="${disciplines}">
                            ...
                            <spring:url value="disciplines/${discipline.id}" var="disciplineUrl" />
                            <spring:url value="disciplines/${discipline.id}/delete" var="deleteUrl" /> 
                            <spring:url value="disciplines/${discipline.id}/update" var="updateUrl" />
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-link" title="view" onclick="location.href = '${disciplineUrl}'">
