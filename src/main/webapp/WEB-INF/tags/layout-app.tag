    ...
    <body class="structure-app-inner">
        <header>
            <div class="top-header">    
                <img id="logo" src="<c:url value="/resources/images/eseco-logo-1.png"/>" alt="E-SECO">
                <img class="logo-ufjf" style="float: right" src="<c:url value="/resources/images/logo_da_UFJF_2.png"/>" alt="UFJF">
            </div>
        </div>
        <nav class="top-menu">
