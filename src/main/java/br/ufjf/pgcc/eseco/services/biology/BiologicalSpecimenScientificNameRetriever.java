...
public class BiologicalSpecimenScientificNameRetriever {
    ...
    public String getSpecimenScientificNameBySpecimenName(String commonName) throws IOException {
        String url = "http://newbiosystems.com/api/scientific-names/by-specimen-name/" + commonName;
